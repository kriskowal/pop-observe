...
var observableArrayProperties = {
    ...
    makeIndexObservable: {
        value: function (index) {
            var observedLength = this.observedLength || 0;
            if (index >= observedLength) {
                hiddenValueProperty.value = index + 1;
                Object.defineProperty(this, "observedLength", hiddenValueProperty);
            }
        },
        writable: true,
        configurable: true
    ...
    swap: {
        value: function swap(start, minusLength, plus) {
            ...
            var observedLength = Math.min(longest, this.observedLength || 0);
